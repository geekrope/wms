import { OpenMeteoProvider, MUNICH_LAT, MUNICH_LON } from "./environment_provider.js";
import { filtfilt, EMA } from "../algorithms/biquad.js";
import { find_peaks } from "../algorithms/peaks.js";
...
function filter_temperature(data, alpha) {
...
function build_temperature_peaks_trace(data, peaks) {
...
function build_peaks_row(data, peak) {
...
function render_peaks_table(container, data, peaks) {
    ...
    for (const peak of sorted_peaks)
        body.appendChild(build_peaks_row(data, peak));
    table.append(head, body);
    container.innerHTML = "";
    container.appendChild(table);
}
function render_temperature_chart(container, data, data_filtered, temperature_peaks) {
...
export async function refresh_climate_plot(container) {
    const end = new Date();
...
//# sourceMappingURL=analytics_climate.js.map