...
export declare const DatabaseTests: {
    ...
    testAddCategoriesRejectsDuplicateActiveTitle(assert: AssertFunc): Promise<void>;
    testAddCategoriesRevivesSoftDeletedTitleOnConflict(assert: AssertFunc): Promise<void>;
