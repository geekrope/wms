...
const LOCALES = {
    EN: {
        ...
        log_delete_box: "DELETED BOX \"{title}\"",
        log_delete_box_fail: "FAILED TO DELETE BOX: {error}",
    ...
    RU_FORMAL: {
        ...
        log_delete_box: "ЯЧЕЙКА \"{title}\" УДАЛЕНА.",
        log_delete_box_fail: "НЕ УДАЛОСЬ УДАЛИТЬ ЯЧЕЙКУ: {error}",
...
export function getCurrentLocale() {
    ...
    if (lang) {
        ...
        lang = sessionStorage.getItem('app_lang') || 'EN';
    }
